...
.author-meta {
  ...
  justify-content: center;
  min-width: 0;           /* Crucial: allows children to truncate */
...
.nav-header {
  ...
  border-bottom: 1px solid rgb(4, 5, 5);
        ...
        .header-btn:hover, .msg-icon-container:hover { color: #e5e7ebff; background: #334155; }
